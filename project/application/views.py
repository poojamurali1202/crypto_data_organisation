...
class UpdateOrganisation(UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        try:
            ...
            organization = Organisation.objects.filter(id=org_id).first()
            if organization:
                ...
                return Response({
                    "status_code": 400,
                    "message": "Organisation Does not exist Cant update the name",
                    "data": []
                })
        except Exception as error:
            return Response({
                "status_code": 500,
                "message": "Cant Update Organisation data",
                "data": []
            })
...
class DeleteOrganisation(DestroyAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        if organization:
            ...
            return Response({
                "status_code": 400,
                "message": "Organisation Does not exist Cant delete ",
                "data": []
            })
